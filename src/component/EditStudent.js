...
function EditStudent()
{
    ...
    useEffect(()=>{
        Axios.get("https://crud-deployment-59hd.onrender.com/students/update-student/" + id)
        .then((res)=>{
            if(res.status === 200){
    ...
    const handleSubmit = () => {
        ...
        Axios.put("https://crud-deployment-59hd.onrender.com/students/update-student/" + id , newObj)
        .then((res)=>{
            if(res.status === 200){
